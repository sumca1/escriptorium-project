    ...
    <div class="m-auto">
        ...
        >
            ...
            <button
                ...
                :title="translate('Transcription management')"
                data-toggle="modal"
                    ...
                    <div class="modal-content">
                        <div class="modal-header ui-draggable-handle">
                            <h5 class="modal-title">
                                {{ translate('Transcriptions management') }}
                            </h5>
                            <button
                                type="button"
                                class="close"
                        ...
                        <div class="modal-body">
                            <div>
                                ...
                                <span class="float-right">{{ translate('Delete') }}</span>
                            </div>
                            <div
                            ...
                            >
                                ...
                                <button
                                    ...
                                    :title="translate('Completely remove the transcription and all of its content! You can not remove the manual or the current transcription.')"
...
export default {
    ...
    mounted() {
        console.log('TranscriptionManagement mounted');
        console.log('EDITOR_TRANSLATIONS:', window.EDITOR_TRANSLATIONS);
        console.log('Test translation:', this.translate('Compare'));
    },
    methods: {
        translate(key) {
            const translation = window.EDITOR_TRANSLATIONS && window.EDITOR_TRANSLATIONS[key] || key;
        ...
        async deleteTranscription(ev) {
            ...
            if(confirm(this.translate("Are you sure you want to delete the transcription? This will affect ALL pages of the document!"))) {

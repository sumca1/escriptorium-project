        ...
        >
            <thead>
                <tr>
                    ...
                    <th>
                        <div><span>{{ $t('Button Text') }}</span></div>
                    </th>
                    <th>
                        <div><span>{{ $t('Components') }}</span></div>
                    </th>
                    <th>
                        <div><span>{{ $t('Type') }}</span></div>
                    </th>
                    <th>
                        <div><span>{{ $t('Marker Type') }}</span></div>
                    </th>
                    <th class="color-column">
                        <div><span>{{ $t('Color') }}</span></div>
                    </th>
                    <th class="comments-column">
                        <div><span>{{ $t('Comments') }}</span></div>
                    </th>
            ...
            <tbody>
                ...
                >
                    ...
                    <!-- marker type -->
                    <td>
                        <DropdownField :label="$t('Marker type')"
                            :disabled="disabled"
        ...
        >
            ...
            <template #modal-content>
                <TextField :label="$t('Name')"
                    ...
                    required
                />
                <TextField :help-text="$t('Comma-separated list of accepted values for this component')"
                    :label="$t('Allowed Values')"
            ...
            <template #modal-actions>
                <EscrButton
                    color="outline-primary" :label="$t('Cancel')"
                    :disabled="disabled"
                    :on-click="closeAddComponentModal"
                />
                <EscrButton
        ...
        getMarkerTypeOptions(item) {
            if (this.tab === "text") {
                return [
                    ...
                    { label: this.$t("Bold"), value: "Bold", selected: item.marker_type === "Bold" },
                    { label: this.$t("Italic"), value: "Italic", selected: item.marker_type === "Italic" },
                ];
            } else if (this.tab === "image") {
                return [
                    {
                        label: this.$t("Rectangle"),
                        value: "Rectangle",
                        selected: item.marker_type === "Rectangle"
                    },
                    {
                        label: this.$t("Polygon"), value: "Polygon", selected: item.marker_type === "Polygon"
                    },
                ];
            }
            return [];

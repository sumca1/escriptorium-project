    ...
    <EscrModal class="escr-edit-ontology">
        ...
        <template #modal-content="{ scroll }">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="name-column">
                            <div><span>{{ translate('Name') }}</span></div>
                        </th>
                        <th
                            v-if="['lines', 'regions'].includes(tab)"
                            class="color-column"
                        >
                            <div><span>{{ translate('Color') }}</span></div>
                        </th>
                    </tr>
                </thead>
                <tbody>
            ...
            <h3 :class="{'anno-header': ['image', 'text'].includes(tab) }">
                ...
                <EscrButton
                    :disabled="disabled"
                    :on-click="async () => { await onAddType(); scroll(); }" :label="translate('Add New')"
                    size="small"
                >
                    <template #button-icon>
                        <PlusIcon />
        ...
        <template #modal-actions>
            ...
            <EscrButton
                color="outline-primary" :label="translate('Cancel')"
                :on-click="onCancel"
                :disabled="disabled"
            />
            <EscrButton
                color="primary" :label="translate('Save')"
...
export default {
    ...
    computed: {
        ...
        /**
         * Append color to each default type object. Also add "${this.translate("None")}".
         */
        ...
        tabOptions() {
            return [
                {
                    label: this.translate("Region Types"),
                    value: "regions",
                    selected: this.tab === "regions",
                },
                {
                    label: this.translate("Line Types"),
                    value: "lines",
                    selected: this.tab === "lines",
                },
                {
                    label: this.translate("Part Types"),
                    value: "parts",
                    selected: this.tab === "parts",
                },
                {
                    label: this.translate("Text Annotations"),
                    value: "text",
                    selected: this.tab === "text",
                },
                {
                    label: this.translate("Image Annotations"),
                    value: "image",

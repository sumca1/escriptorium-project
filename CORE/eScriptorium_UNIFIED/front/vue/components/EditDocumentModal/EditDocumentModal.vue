    ...
    <EscrModal class="escr-edit-document">
        ...
        <template #modal-content>
            <TextField :label="translate('Name')"
                ...
                required
            />
            <DropdownField :label="translate('Script')"
                :disabled="disabled"
                :on-change="handleMainScriptChange"
                :options="scriptOptions"
                required
            />
            <DropdownField :label="translate('Read Direction')"
                :disabled="disabled"
                :help-text="(
                ...
                required
            />
            <DropdownField :label="translate('Line Position')" :help-text="translate('The position of the line relative to the polygon.')"
                :disabled="disabled"
            ...
            />
            <TagsField :label="translate('Tags')"
                :disabled="disabled"
    ...
    computed: {
        ...
        readDirectionOptions() {
            return [
                {
                    value: "ltr",
                    label: this.translate("Left to right"),
                    selected: this.readDirection === "ltr",
                },
                {
                    value: "rtl",
                    label: this.translate("Right to left"),

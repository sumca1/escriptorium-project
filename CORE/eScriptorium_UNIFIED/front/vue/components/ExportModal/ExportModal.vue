    ...
    >
        ...
        <template #modal-content>
            ...
            <ArrayField
                ...
                class="escr-region-types" :help-text="translate('Select region types to include in the export.')"
    ...
    computed: {
        ...
        fileFormatOptions() {
            const formatOptions = [
                ...
                {
                    label: this.translate("PageXML"),
                    value: "pagexml",
                    selected: this.fileFormat === "pagexml",
                },
                {
                    label: this.translate("ALTO"),
                    value: "alto",
            ...
            if (this.markdownEnabled) {
                formatOptions.push({
                    label: this.translate("OpenITI Markdown"),
            ...
            if (this.teiEnabled) {
                formatOptions.push({
                    label: this.translate("OpenITI TEI XML"),
                    value: "teixml",

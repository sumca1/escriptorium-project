<template>
    <fieldset class="escr-align-advanced">
        <legend><h3>{{ translate('Advanced Settings') }}</h3></legend>
        <label class="escr-text-field">
            <div>
                <span>{{ translate('Line length threshold') }}</span>
                <VDropdown
                    theme="escr-tooltip"
        ...
        <label class="escr-text-field">
            ...
            <input
                ...
                min="0"
                max="100"
                :placeholder="translate('Beam size')"
        ...
        <label class="escr-text-field">
            <div>
                <span>{{ translate('Max offset') }}</span>
                <VDropdown
                    theme="escr-tooltip"
            ...
            <input
                ...
                min="0"
                max="80"
                :placeholder="translate('Max offset')"

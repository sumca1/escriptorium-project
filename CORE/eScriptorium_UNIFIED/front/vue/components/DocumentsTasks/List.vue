    ...
    <div>
        <div class="row">
            <div class="col">
                <div class="form-group">
                    <label>{{ translate('Task state') }}</label>
                    <select
        ...
        <table class="table table-hover">
            <tr>
                ...
                <th>{{ translate("Last task started") }}</th>
            ...
            <template v-else>
                <tr>
                    <td colspan="6">
                        {{ translate("No document tasks to display.") }}
                    </td>
                </tr>
            </template>
        </table>
        ...
        <button
            ...
            :title="translate('Cancel pending/running tasks for the selected documents')"
            class="btn btn-danger"
            :disabled="!selectedList || !Object.values(selectedList).length"
        >
            {{ translate("Cancel all selected") }}
        </button>

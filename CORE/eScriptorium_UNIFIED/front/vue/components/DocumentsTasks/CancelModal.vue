        ...
        >
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>{{ translate('You are about to cancel all pending/running tasks for documents:') }}</p>
                    <ul>
                        <li
                    ...
                    <p>{{ translate('Please confirm that you want to proceed.') }}</p>
                </div>

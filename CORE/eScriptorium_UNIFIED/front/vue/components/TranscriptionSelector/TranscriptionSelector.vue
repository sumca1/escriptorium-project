    ...
    >
        <EscrButton
            ...
            :label="comparedTranscriptions.length
                ? `${comparedTranscriptions.length} ${translate('selected')}`
                : translate('Select')"
        >
        ...
        <template #popper>
            <div class="escr-transcription-selector">
                <div class="selector-header">
                    <h3>{{ translate('Transcriptions') }}</h3>
                    <div>
                        <EscrButton :label="translate('Select All')"
                            color="link-primary"
                            size="small"
                            :on-click="selectAll"
                            :disabled="comparedTranscriptions.length === allTranscriptionsSorted.length"
                        />
                        <EscrButton :label="translate('Select None')"
                            color="link-primary"
                            size="small"
                            :on-click="selectNone"

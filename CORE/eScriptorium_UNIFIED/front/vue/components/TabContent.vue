        ...
        >
            ...
            >
                <a
                    ...
                    :title="translate('Next (Page Down or Ctrl+Left Arrow)')"
                    @click="getNext"
                >
                ...
                <a
                    ...
                    :title="translate('Previous (Page Up or Ctrl+Right Arrow)')"
                    @click="getPrevious"
                >
                    <i class="fas fa-angle-left" /></a>
                <div>
                    <button
                        ...
                        :title="translate('Reset zoom. (Ctrl+Backspace)')"
                        @click="resetZoom"
                    >
                    ...
                    <button
                        ...
                        :title="translate('Zoom in. (mousewheel up)')"
                        @click="zoomIn"
                    >
                    ...
                    <button
                        ...
                        :title="translate('Zoom out. (mousewheel down)')"
                        @click="zoomOut"
                    >
            ...
            >
                <a
                    ...
                    href="#"
                    class="nav-btn nav-prev"
                    :title="translate('Previous (Page Up or Ctrl+Left Arrow)')"
                    @click="getPrevious"
                >
                ...
                <a
                    ...
                    href="#"
                    class="nav-btn nav-next"
                    :title="translate('Next (Page Down or Ctrl+Right Arrow)')"
                    @click="getNext"
                >
                    <i class="fas fa-angle-right" />
                </a>

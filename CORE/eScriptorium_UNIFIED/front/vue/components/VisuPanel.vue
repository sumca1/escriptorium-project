    ...
    >
        ...
        >
            ...
            <input
                ...
                max="10"
                step="0.1"
                :title="translate('Scale the color range for average confidence visualizations')"
                ...
                <div class="escr-editortools-paneltools">
                    ...
                    <div class="escr-confidence-control">
                        ...
                        >
                            ...
                            <template #popper>
                                {{ translate('Confidence visualization') }}
                            </template>
                        </VDropdown>
                        <VDropdown
                        ...
                        >
                            ...
                            <template #popper>
                                <div class="confidence-scale">
                                    <h3>{{ translate('Confidence range scale') }}</h3>
                                    <input
                                        id="confidence-range"
                                        type="range"
                                        class="custom-range"

            ...
            >
                <template #actions="{ item }">
                    ...
                    <EscrButton
                        ...
                        :disabled="disabled"
                        :aria-label="translate('Delete transcription')"
                    >
                        <template #button-icon>
                            <TrashIcon />
                        </template>
...
export default {
    ...
    computed: {
        ...
        headers() {
            return [
                { label: this.translate("Name"), value: "name", sortable: true, editable: true },
                {
                ...
                { label: this.translate("Comments"), value: "comments", sortable: false, editable: true },
            ];
        },
    ...
    mounted() {
        console.log('🔍 TranscriptionsModal mounted!');
        console.log('EDITOR_TRANSLATIONS:', window.EDITOR_TRANSLATIONS);
        console.log('Test translate(Transcriptions):', this.translate('Transcriptions'));
        console.log('Test translate(Name):', this.translate('Name'));
    },
    methods: {
        translate(key) {
            const result = window.EDITOR_TRANSLATIONS && window.EDITOR_TRANSLATIONS[key] || key;

        ...
        >
            ...
            >
                <button
                    ...
                    :title="translate('Download full size image')"
                    download
                />
            </a>
            <div class="btn-group">
                <button
                    ...
                    :title="translate('Rotate 90° counter-clockwise.')"
                ...
                <button
                    id="rotate-clock"
                    :title="translate('Rotate 90° clockwise.')"
...
export default {
    ...
    methods: {
        ...
        getCoordinatesFromW3C(annotation) {
            var coordinates = [];
            if (annotation.target.selector.type == this.translate("FragmentSelector")) {
                // eslint-disable-next-line max-len
            ...
            } else if (annotation.target.selector.type == this.translate("SvgSelector")) {
                // eslint-disable-next-line max-len
        ...
        updateW3CCoordsToUIImg(selector) {
            ...
            const scale = this.$refs.img.naturalWidth / this.$store.state.parts.image.size[0];
            if (selector.type == this.translate("FragmentSelector")) {
            ...
            } else if (selector.type == this.translate("SvgSelector")) {

<template>
    ...
    >
        ...
        <template #modal-content>
            ...
            />
            <DropdownField
                :label="translate('Text Direction')"
                :disabled="disabled"
...
export default {
    ...
    computed: {
        ...
        includeOptions() {
            return [
                {
                    label: this.translate("Lines"),
                    value: "lines",
                    selected: this.include.includes("lines"),
                },
                {
                    label: this.translate("Regions"),
                    value: "regions",
        ...
        modelOptions() {
            const defaultModel = [{
                label: this.translate("Default Segmentation Model"),
                value: null,
                selected: !this.model,
            }];
        ...
        textDirectionOptions() {
            return [
                {
                    label: this.translate("Horizontal Left to Right"),
                    value: "horizontal-lr",
                    selected: this.textDirection === "horizontal-lr",
                },
                {
                    label: this.translate("Horizontal Right to Left"),
                    value: "horizontal-rl",
                    selected: this.textDirection === "horizontal-rl",
                },
                {
                    label: this.translate("Vertical Left to Right"),
                    value: "vertical-lr",
                    selected: this.textDirection === "vertical-lr",
                },
                {
                    label: this.translate("Vertical Right to Left"),
                    value: "vertical-rl",

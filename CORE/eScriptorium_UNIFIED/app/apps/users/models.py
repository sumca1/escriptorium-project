...
class User(AbstractUser):
    ...
    # User's preferred language for interface and background task notifications
    language = models.CharField(
        max_length=10,
        choices=[('en', _('English')), ('he', _('Hebrew')), ('fr', _('French'))],
        null=True,
        blank=True,
        help_text=_("User's preferred language. If not set, system default language will be used."),
    )
...
class ResearchField(models.Model):
    ...
    class Meta:
        verbose_name = _('research field')
        verbose_name_plural = _('research fields')
...
class QuotaEvent(models.Model):
    ...
    class Meta:
        verbose_name = _('quota event')
        verbose_name_plural = _('quota events')

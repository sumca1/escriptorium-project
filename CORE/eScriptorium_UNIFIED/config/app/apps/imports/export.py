...
# Placeholder exporters for PDF/DOCX (handled by separate views in core.views_export)
class PDFExporterPlaceholder:
    """Placeholder for PDF export - actual export handled by core.views_export.export_pdf"""
    pass


class DOCXExporterPlaceholder:
    """Placeholder for DOCX export - actual export handled by core.views_export.export_docx"""
    pass
...
ENABLED_EXPORTERS = {
    ...
    PDF_FORMAT: {"class": PDFExporterPlaceholder, "label": "PDF"},
    DOCX_FORMAT: {"class": DOCXExporterPlaceholder, "label": "DOCX"},
}
